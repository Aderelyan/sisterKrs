                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="nidn" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" type="text" name="nidn" value="{{ old('nidn') }}" required autofocus placeholder="Masukkan NIDN Anda" />
                        </div>
                        @error('nidn')
