        ...
        <div class="glass rounded-2xl p-8 shadow-2xl">
            <div class="text-center">
                ...
                <p class="text-gray-600">
                    Masuk ke Sistem Klaim Kelas Dosen
                </p>
            </div>
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" type="text" name="email" value="{{ old('email') }}" required autofocus placeholder="Masukkan NIDN Anda" />
                        </div>
                        @error('email')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" type="password" name="password" required placeholder="Masukkan password Anda" />
                        </div>
                        @error('password')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        Belum punya akun?
                        <a href="{{ route('register.dosen') }}" class="font-medium text-blue-600 hover:text-blue-500 transition duration-200">
